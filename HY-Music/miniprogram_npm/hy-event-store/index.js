...
__DEFINE__(1735785659005, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1735785659006,"./event-store":1735785659007}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1735785659006, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1735785659007, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1735785659006,"./utils":1735785659008}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1735785659008, function(require, module, exports) {
...
return __REQUIRE__(1735785659005);
})()
